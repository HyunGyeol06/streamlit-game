...
def create_game(
    ...
    if game_name != "":
        st.write("매우 엄청나고 으메이징한 게임:", game_name)
...
genre = st.selectbox("장르", ["액션", "어드벤처", "RPG", "스포츠", "레이싱", "시뮬레이션", "전략", "퍼즐", "음악", "캐주얼", "아케이드"])
age = st.selectbox("연령대", ["전체", "12세 이상", "15세 이상", "18세 이상"])
